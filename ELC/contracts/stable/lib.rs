...
mod stable {
    ...
    pub struct Stable {
        ...
        govern_contract: Lazy<Govern>,
        oracle_contract: Lazy<Oracle>,
        add_contract: Lazy<Additional>,
        exchange_contract: Lazy<PatraExchange>,
    ...
    impl Stable {
        ...
        pub fn new (
            ...
            let govern_contract: Govern = FromAccountId::from_account_id(govern_addr);
            ...
            let exchange_contract: PatraExchange = FromAccountId::from_account_id(exchange_addr);
